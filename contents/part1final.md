...
## Ratio
To further quantify how negativity is distributed across communities, we examine the ratio of negative links generated by individual subreddits.
The associated visualization highlights a striking concentration pattern.

[graph notebook marzio]

Results from this analysis show that the top 50 subreddits alone account for approximately half of all negative links observed in the dataset. This means that a very small fraction of communities is responsible for a disproportionate share of hostile interactions.

This extreme concentration reinforces a central conclusion of our study:
- online negativity is not evenly distributed, but driven by a limited number of highly influential subreddits, which play an outsized role in shaping the overall tone of interactions across Reddit.
